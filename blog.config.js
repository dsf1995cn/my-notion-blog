...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.notion.so/api/v3', // API 默认请求地址，可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  IS_TAG_COLOR_DISTINGUISHED:
    process.env.NEXT_PUBLIC_IS_TAG_COLOR_DISTINGUISHED === 'true' || true, // 对于名称相同的 tag 是否区分 tag 的颜色
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'dsf', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://docs.onehat.cn', // 网站地址
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://cdn.jsdelivr.net/npm/twikoo@1.6.17/dist/twikoo.all.min.js', // twikoo 客户端 cdn
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '3806269138', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴 html 代码中的 data-ad-slot 值
